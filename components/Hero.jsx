...
export default function Hero() {
  return (
    <main className="pt-16 flex justify-center w-full bg-white"> {/* Center container */}
      <div className="w-full max-w-[1440px]"> {/* Max-width container */}
        <section className="flex flex-col md:flex-row min-h-[calc(100vh-64px)]">
          ...
          {/* Image Section */}
          <div className="mt-0 md:mt-0 relative flex-1 md:w-1/2">
            {/* <Image
              src="/hero.png"
              ...
              priority
            /> */}
            <img src="/h3.png" alt="Image" width={400}/>
